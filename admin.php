...
?>
    ...
    <div class="card mb-4">
     ...
     <?php $gia = file_get_contents('https://fakebillck.com/api/bill-info.php'); ?>
     <div class="alert alert-primary mt-2">
         Giá bill nguồn hiện tại: <?php echo '<b>'.number_format($gia).'đ</b>/bill.<br/>Bạn lãi được <b>'.number_format($giabill-$gia).'đ</b>/bill' ?>
     </div>
     <?php
     $json1 = json_decode(file_get_contents('https://fakebillck.com/api/info.php?key='.$key));
     if($json1->trangthai == 'success'){
         ...
         echo '<div class="alert alert-danger">Serial của bạn không hợp lệ! Vui lòng cập nhật lại. Lấy API key tại <a href="//fakebillck.com">fakebillck.com</a></div>';
     }
     ?>
      </div>
    </div>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
          ...
          <div class="col-md-10">
            ...
            <small>Có thể được lấy tại <a href="https://fakebillck.com">fakebillck.com</a></small>
          </div>
